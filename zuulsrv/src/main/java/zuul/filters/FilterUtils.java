...
public class FilterUtils {
  ...
  public String getCorrelationId() {
    ...
    if (zuulContext.getRequest().getHeader(CORRELATION_ID) != null) {
      return zuulContext.getRequest().getHeader(CORRELATION_ID);
    } else {
      return zuulContext.getZuulRequestHeaders().get(CORRELATION_ID);
    }
  }
