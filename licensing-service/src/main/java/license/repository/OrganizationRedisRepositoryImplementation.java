...
@Repository
@NoArgsConstructor
public class OrganizationRedisRepositoryImplementation implements OrganizationRedisRepository{
    private static final String HASH_NAME="organization";
    private RedisTemplate<String, Organization> redisTemplate;
    private HashOperations hashOperations;

    @Autowired
    private OrganizationRedisRepositoryImplementation(RedisTemplate redisTemplate){
